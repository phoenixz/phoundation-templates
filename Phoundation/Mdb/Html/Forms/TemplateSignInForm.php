...
class TemplateSignInForm extends TemplateRenderer
{
     ...
     */
    public function __construct(SignInForm $_component)
    {
    ...
    public function render(): ?string
    {
        $this->render = ' <!-- Email input -->
                          <div class="form-outline mb-4">
                            <input type="email" id="email" name="email" class="form-control"' . (array_get_safe($get, 'email') ? ' value="' . $get['email'] . '"' : '') . '/>
                          ...
                          <div class="row mb-4">
                            ...
                            <div class="col">
                              <!-- Simple link -->
                              ' . Anchor::new($this->_component->getForgotPasswordUrl())->setContent(tr('Forgot password?')) . '
                            </div>
                          </div>
                          ...
                          <div class="text-center">
                            <p>' . tr('Not a member?') . Anchor::new($this->_component->getRegisterUrl())->setContent(tr('Register')) . '</p>
