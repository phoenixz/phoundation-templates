...
namespace Templates\Phoundation\AdminLteV3\Html\Components\Widgets\Cards;
...
class TemplateCard extends TemplateRenderer
{
    ...
    public function render(): ?string
    {
        ...
        if ($tabs) {
            ...
            $buttons = $this->_component->getButtonsObject()?->render();

            if ($buttons or $this->_component->getFooterContent()) {
